...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self._parser.add_argument(
            "--train_ids_file",
            type=str,
            default="train_ids.csv",
            help="file containing train ids",
        )
        self._parser.add_argument(
            "--test_ids_file",
            type=str,
            default="test_ids.csv",
            help="file containing test ids",
        )
        self._parser.add_argument(
            "--images_folder", type=str, default="imgs", help="images folder"
        )
        self._parser.add_argument(
            "--aus_file",
            type=str,
            default="aus_openface.pkl",
        ...
        self._parser.add_argument(
            "--image_size", type=int, default=128, help="input image size"
        )
        self._parser.add_argument(
            "--cond_nc", type=int, default=17, help="# of conditions"
        )
        self._parser.add_argument(
            "--gpu_ids",
            type=str,
        ...
        self._parser.add_argument(
            "--dataset_mode", type=str, default="aus", help="chooses dataset to be used"
        )
        self._parser.add_argument(
            "--model", type=str, default="ganimation", help="model to run[au_net_model]"
        )
        self._parser.add_argument(
            "--n_threads_test", default=1, type=int, help="# threads for loading data"
        )
        self._parser.add_argument(
            "--checkpoints_dir",
            type=str,
        ...
        self._parser.add_argument(
            ...
            action="store_true",
            default=False,
            help="do use mask_fake for mask_cyc",
        )
    ...
    def _save(self, args):
        ...
        file_name = os.path.join(
            expr_dir, "opt_%s.txt" % ("train" if self.is_train else "test")
        )
