...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument(
            "--train_G_every_n_iterations",
            type=int,
            default=5,
            help="train G every n interations",
        )
        self._parser.add_argument(
            "--poses_g_sigma",
            type=float,
        ...
        self._parser.add_argument(
            ...
            type=float,
            default=0.0001,
            help="initial learning rate for D adam",
        )
        self._parser.add_argument(
        ...
        self._parser.add_argument(
            ...
            type=float,
            default=4000,
            help="lambda for condition discriminator loss",
        )
        self._parser.add_argument(
            "--lambda_cyc", type=float, default=10, help="lambda cycle loss"
        )
        self._parser.add_argument(
            "--lambda_mask", type=float, default=0.1, help="lambda mask loss"
        )
        self._parser.add_argument(
